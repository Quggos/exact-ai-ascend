...
const BookCall = () => {
	...
	return (
		<div
			className="min-h-screen bg-[#fafafa] text-foreground overflow-x-hidden"
			ref={topRef}
		>
			...
			<main className="container mx-auto px-4 sm:px-8 py-16 sm:py-24">
				<div className="max-w-4xl mx-auto">
					<h1 className="text-3xl sm:text-5xl font-bold mb-6 tracking-tight text-black">
						Book a Free Call
					</h1>
					<p className="text-lg mb-12 tracking-tight text-black/80">
