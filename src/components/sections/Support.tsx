	...
	const supportFeatures = [
		{
			...
			description:
				'Continuous system monitoring to ensure optimal performance and quick issue detection.',
		...
		},
		{
			...
			description:
				'Automatic updates to the latest AI models and features to keep your system cutting-edge.',
			gradient: 'from-[#FFA4A4] to-[#EB2525]',
		},
		{
			icon: BarChart3,
		...
		},
		{
			...
			description:
				'Round-the-clock technical support with priority response for critical issues.',
			gradient: 'from-[#FFA4A4] to-[#EB2525]',
		},
	];
			...
			<div className="lg:container md:container mx-auto relative z-10">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					{supportFeatures.map((feature, index) => (
						...
						>
							<div
								className="absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-10 transition-opacity duration-300 rounded-3xl"
								style={{
