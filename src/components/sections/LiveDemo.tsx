												...
												<div className="space-y-6">
													<div className="flex items-start">
														...
														<div className="glass-morphism rounded-2xl rounded-tl-none p-4 text-md">
															<p>
																Hello! I'm your EXACT AI assistant. How can I
																help you today?
															</p>
														</div>
													</div>
													...
													<div className="flex items-start justify-end">
														<div className="glass-morphism rounded-2xl rounded-tr-none p-4 text-md">
															<p>
																I can't log into my account. I keep getting an
																error message.
															</p>
														</div>
													...
													<div className="flex items-start">
														...
														<div className="glass-morphism rounded-2xl rounded-tl-none p-4 text-md">
															<p>
																I'm sorry to hear you're having trouble logging
																in. Let's fix this right away. Could you tell
																me:
															</p>
															<ol className="mt-2 space-y-1 list-decimal list-inside">
																...
																<li>
																	Are you using the email address you registered
																	with?
																</li>
													...
													<div className="flex items-start justify-end">
														<div className="glass-morphism rounded-2xl rounded-tr-none p-4 text-md">
															<p>
																It says "Invalid credentials" and yes, I'm using
																the right email. I haven't tried resetting my
																password yet.
															</p>
														</div>
														<div className="w-8 h-8 rounded-full bg-gradient-to-br from-gray-200 to-gray-400 flex items-center justify-center text-gray-800 font-bold text-xs ml-4 flex-shrink-0">
													...
													<div className="flex items-start">
														...
														<div className="glass-morphism rounded-2xl rounded-tl-none p-4 text-md">
															<p>
																Let's try resetting your password first, as
																that's the most common solution. Here's how:
															</p>
															<ol className="mt-2 space-y-1 list-decimal list-inside">
															...
															<p className="mt-2">
																I can also generate a password reset link
																directly if you confirm your email address.
											...
											{activeTab === 1 && (
												<div className="space-y-6">
													...
													<div className="flex items-start justify-end">
														<div className="glass-morphism rounded-2xl rounded-tr-none p-4 text-md">
															<p>
																I'm interested in your premium plan, but I need
																to know if it works with Shopify.
															</p>
														</div>
														<div className="w-8 h-8 rounded-full bg-gradient-to-br from-gray-200 to-gray-400 flex items-center justify-center text-gray-800 font-bold text-xs ml-4 flex-shrink-0">
															U
													...
													<div className="flex items-start">
														...
														<div className="glass-morphism rounded-2xl rounded-tl-none p-4 text-md">
															<p>
																Yes, our Premium Plan integrates seamlessly with
																Shopify! You get:
															</p>
															<ul className="mt-2 space-y-1 list-disc list-inside">
																...
																<li>
																	Real-time access to product inventory and
																	details
																</li>
															...
															<p className="mt-2">
																Many Shopify merchants see a 30-40% reduction in
																support tickets and a 25% increase in conversion
																rate after implementation. What size is your
																Shopify store?
															</p>
														</div>
													</div>
													...
													<div className="flex items-start justify-end">
														<div className="glass-morphism rounded-2xl rounded-tr-none p-4 text-md">
															<p>
																We have about 200 products and process around
													...
													<div className="flex items-start">
														...
														<div className="glass-morphism rounded-2xl rounded-tl-none p-4 text-md">
															<p>
																Perfect! For your store size, our Business Plan
																at $6,000 would be ideal. It includes:
															</p>
															<ul className="mt-2 space-y-1 list-disc list-inside">
																<li>Up to 10,000 AI interactions monthly</li>
																<li>
																	All Shopify integrations mentioned earlier
																</li>
															...
															<p className="mt-2">
																Would you like to see a personalized demo with
																your actual Shopify store data? I can arrange a
																30-minute session with our integration
																specialist.
															</p>
														</div>
													</div>
											...
											{activeTab === 2 && (
												<div className="space-y-6">
													...
													<div className="flex items-start justify-end">
														<div className="glass-morphism rounded-2xl rounded-tr-none p-4 text-md">
															<p>
																How do I connect your chatbot to my website? Is
																there any code I need to add?
															</p>
														</div>
														<div className="w-8 h-8 rounded-full bg-gradient-to-br from-gray-200 to-gray-400 flex items-center justify-center text-gray-800 font-bold text-xs ml-4 flex-shrink-0">
															U
													...
													<div className="flex items-start">
														...
														<div className="glass-morphism rounded-2xl rounded-tl-none p-4 text-md">
															<p>
																Great question! Integrating our AI chat
																assistant with your website is simple. You have
																two options:
															</p>

															<p className="mt-2 font-medium">
																Option 1: No-Code Installation
															</p>
															...
															<p className="mt-2 font-medium">
																Option 2: Developer API (for custom
																implementation)
															</p>
															<p className="text-muted-foreground">
																If you need deeper customization, we provide a
																JavaScript SDK and REST API.
															</p>

															<p className="mt-2">
																Which option sounds better for your needs? I can
																provide more specific details on either
																approach.
															</p>
														</div>
													</div>
													...
													<div className="flex items-start justify-end">
														<div className="glass-morphism rounded-2xl rounded-tr-none p-4 text-md">
															<p>
																The no-code option sounds easier. Will it work
																with WordPress?
															</p>
														</div>
														<div className="w-8 h-8 rounded-full bg-gradient-to-br from-gray-200 to-gray-400 flex items-center justify-center text-gray-800 font-bold text-xs ml-4 flex-shrink-0">
													...
													<div className="flex items-start">
														...
														<div className="glass-morphism rounded-2xl rounded-tl-none p-4 text-md">
															<p>
																Yes, it works perfectly with WordPress! For
																WordPress sites, we actually have an even easier
																option:
															</p>

															<ol className="mt-2 space-y-1 list-decimal list-inside">
																<li>
																	Install our "EXACT AI Chat" plugin from the
																	WordPress plugin directory
																</li>
																<li>Activate the plugin</li>
																<li>
																	Enter your EXACT AI API key (found in your
																	dashboard)
																</li>
																<li>
																	Configure appearance and behavior in the
																	plugin settings
																</li>
															</ol>

															<p className="mt-2">
																The WordPress plugin also includes additional
																features like WooCommerce integration for
																e-commerce sites. Would you like me to share
																documentation links for the WordPress
																installation?
															</p>
														</div>
													</div>
											...
											{activeTab === 3 && (
												<div className="space-y-6">
													...
													<div className="flex items-start justify-end">
														<div className="glass-morphism rounded-2xl rounded-tr-none p-4 text-md">
															<p>
																I need to change my billing information for my
																subscription.
															</p>
														</div>
														<div className="w-8 h-8 rounded-full bg-gradient-to-br from-gray-200 to-gray-400 flex items-center justify-center text-gray-800 font-bold text-xs ml-4 flex-shrink-0">
													...
													<div className="flex items-start">
														...
														<div className="glass-morphism rounded-2xl rounded-tl-none p-4 text-md">
															<p>
																I'd be happy to help you update your billing
																information. To protect your account security,
																I'll need to verify a few details first. Could
																you please provide:
															</p>
															<ol className="mt-2 space-y-1 list-decimal list-inside">
																<li>
													...
													<div className="flex items-start justify-end">
														<div className="glass-morphism rounded-2xl rounded-tr-none p-4 text-md">
															<p>
																My email is john@techinnovate.com and the
																company is Tech Innovate LLC.
															</p>
														</div>
														<div className="w-8 h-8 rounded-full bg-gradient-to-br from-gray-200 to-gray-400 flex items-center justify-center text-gray-800 font-bold text-xs ml-4 flex-shrink-0">
															U
													...
													<div className="flex items-start">
														...
														<div className="glass-morphism rounded-2xl rounded-tl-none p-4 text-md">
															<p>
																Thank you for providing that information. I've
																located your account, Tech Innovate LLC, with
																the Business Plan subscription.
															</p>

															<p className="mt-2">
																You have two options to update your billing
																information:
															</p>

															<ol className="mt-2 space-y-1 list-decimal list-inside">
																<li>
																	I can send a secure link to
																	john@techinnovate.com where you can update
																	your payment details directly
																</li>
																<li>
																	You can update it yourself in the Billing
																	section of your dashboard at app.exactai.com
																</li>
															</ol>
